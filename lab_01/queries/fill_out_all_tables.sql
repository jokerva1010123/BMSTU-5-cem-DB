...
COPY veterinarian FROM 'D:\BMSTU\BMSTU-5-cem-DB\lab_01\database_csv\veterinarians.csv' DELIMITER ',' CSV;
COPY treatment FROM 'D:\BMSTU\BMSTU-5-cem-DB\lab_01\database_csv\treatments.csv' DELIMITER ',' CSV;
COPY diagnosis FROM 'D:\BMSTU\BMSTU-5-cem-DB\lab_01\database_csv\diagnosises.csv' DELIMITER ',' CSV;
COPY animals FROM 'D:\BMSTU\BMSTU-5-cem-DB\lab_01\database_csv\animals.csv' DELIMITER ',' CSV;